...
//  def getVersion(): /*TODO Type: 'jQuery.sap.Version' not found.*/ = js.native
//  def getWhitelistService(): String = js.native
//  def setCalendarType(sCalendarType: CalendarType | /*TODO Type: 'null' not found.*/): this.type = js.native
//  def setFormatLocale(sFormatLocale: String | /*TODO Type: 'null' not found.*/): this.type = js.native
